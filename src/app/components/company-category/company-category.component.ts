...
export class CompanyCategoryComponent implements OnInit {
  ...
  isFilterOpen = false;
  filteredCompanyCategoryList: any[] = [];
  ...
  formTitle = 'Company Category Form';

  constructor(private fb: FormBuilder, private router: Router, private route: ActivatedRoute, private companyCategoryService: CompanyCategoryService, private toastService: ToastService) {
  ...
  fetchData() {
    this.companyCategoryService.getAllCompanyCategories(this.payload).subscribe({
      next: (response) => {
        this.filteredCompanyCategoryList = response?.items || [];
  ...
  openModal(type: string, id: number): void {
    ...
    if (type === 'create') {
      ...
      this.isEditMode = false;
      this.formTitle = 'View Company Category';
