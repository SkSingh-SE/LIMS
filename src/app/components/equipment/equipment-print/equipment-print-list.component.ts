...
@Component({
    selector: 'app-equipment-print-list',
    standalone: true,
    imports: [CommonModule, RouterModule, NablPrintHeaderComponent, NablPrintFooterComponent, PrintFrameComponent],
    templateUrl: './equipment-print-list.component.html',
    styleUrl: './equipment-print-list.component.css'
})
export class EquipmentPrintListComponent implements OnInit {
    data: any = null;
    ...
    goBack() { this.router.navigate(['/equipment']); }
