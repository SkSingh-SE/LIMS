...
@Component({
    selector: 'app-audit-summary-preview',
    standalone: true,
    imports: [CommonModule, RouterModule, NablPrintHeaderComponent, NablPrintFooterComponent, PrintFrameComponent],
    templateUrl: './audit-summary-preview.component.html',
    styleUrl: './audit-summary-preview.component.css'
})
export class AuditSummaryPreviewComponent implements OnInit {
    recordId: number = 0;
    data: any = null;
    ...
    printPage(): void {
        document.getElementById('asm-print-size')?.remove();
        const styleEl = document.createElement('style');
        styleEl.id = 'asm-print-size';
    ...
    goBack() { this.router.navigate(['/audit-summary']); }
}
