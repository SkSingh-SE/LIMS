...
@Component({
    selector: 'app-non-conforming-work-preview-list',
    standalone: true,
    imports: [CommonModule, RouterModule, NablPrintHeaderComponent, NablPrintFooterComponent, PrintFrameComponent],
    templateUrl: './non-conforming-work-preview-list.component.html',
    styleUrl: './non-conforming-work-preview-list.component.css'
})

export class NonConformingWorkPreviewListComponent implements OnInit {
    data: any = null;
